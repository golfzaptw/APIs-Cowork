...
Mobile.waitForElementPresent(findTestObject('INSIDE_NAVBAR/navbarLogout'), 0)

Mobile.tap(findTestObject('INSIDE_NAVBAR/navbarLogout'), 0)

Mobile.waitForElementPresent(findTestObject('INSIDE_NAVBAR/LOGOUT/btn OK'), 0)

Mobile.tap(findTestObject('INSIDE_NAVBAR/LOGOUT/btn OK'), 0)

Mobile.scrollToText('Home', FailureHandling.STOP_ON_FAILURE)
