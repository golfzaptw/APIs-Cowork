...
Mobile.setText(findTestObject('REGISTERPAGE/edt/edt Email Address'), 'testdata', 0)
...
Mobile.scrollToText(GlobalVariable.ERROR_FORMAT_EMAIL, FailureHandling.STOP_ON_FAILURE)
