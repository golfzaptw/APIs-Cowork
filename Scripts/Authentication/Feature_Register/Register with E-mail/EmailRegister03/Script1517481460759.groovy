...
Mobile.setText(findTestObject('REGISTERPAGE/edt/edt RePassword'), '123123', 0)
...
Mobile.scrollToText(GlobalVariable.WRONG_PASSNOTMATCH, FailureHandling.STOP_ON_FAILURE)
