...
Mobile.setText(findTestObject('REGISTERPAGE/edt/edt Email Address'), 'psgolf11@gmail.com', 0)

'รอใส่พาส'
Mobile.waitForElementPresent(findTestObject('REGISTERPAGE/edt/edt Password'), 0)

Mobile.setText(findTestObject('REGISTERPAGE/edt/edt Password'), '12', 0)
...
Mobile.setText(findTestObject('REGISTERPAGE/edt/edt RePassword'), '12', 0)
...
'error pass 6-30'
Mobile.scrollToText(GlobalVariable.ERROR_PASS630, FailureHandling.STOP_ON_FAILURE)
